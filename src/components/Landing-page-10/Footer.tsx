      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:max-w-5xl justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6 md:max-w-xl">
          <div className="grid gap-4">
            <span className="font-medium text-[10px] leading-3 -tracking-wider">
              ALL
            </span>
          ...
          <div className="grid gap-4">
            <span className="font-medium text-[10px] leading-3 tracking-[4%]">
              INFO
            </span>
            {options.info.map((option, index) => (
              <Link
                href={option.url}
                className="text-[16px] leading-5 tracking-[-0.02em] font-medium text-[#A8A8A8]"
                key={index}
              >
                {option.label}
              </Link>
